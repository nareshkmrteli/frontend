...
export function ListProposalReducer(state=list_initial,action){
    var newstate=null
    switch(action.type){
        case "GET_LIST":
            newstate={
...
// proposal create reducer
export function CreateProposalReducer(state=create_initial,action){
    var newstate=null
    switch(action.type){
        case "CREATE_PROPOSAL":
            ...
            break
        case "CREATE_PROPOSAL_SUCCESSFUL":
            newstate={
                ...state,
                create_loading:false,
...
export function DeleteProposalReducer(state=delete_initial,action){
    var newstate=null
    switch(action.type){
        case "DELETE_PROPOSAL":
            ...
            break
        case "DELETE_PROPOSAL_SUCCESSFUL":
            newstate={
                ...state,
                delete_loading:false,
...
//combine reducer
export const  proposalReducer=combineReducers({
    'list' : ListProposalReducer,
    'create' : CreateProposalReducer,
    'delete':DeleteProposalReducer
})
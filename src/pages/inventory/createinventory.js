...
import {useDispatch as i_useDispatch  } from '../../redux/inventory/inventory'
import {useSelector as i_useSelector} from '../../redux/inventory/inventory'
...
export function CreateInventory(props){
    ...
    return(
        ...
        {   
            ...
            <Snackbars message='Inventory Add successfuly'/>
        }         
        </Container>
